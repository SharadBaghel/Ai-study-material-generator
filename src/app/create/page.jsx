...
const GenerateCourseOutline=async()=>{
    ...
    toast("Your Courses content is generating, Click on Refresh Button.")
  ...
  return (
    <div className='flex flex-col items-center p-5 md:px-24 lgl:px-36 mt-20'>
        <h2 className='font-bold text-4xl text-primary'>Start Assembling Your Custom Study Materials</h2>
        <p className='text-gray-500 text-lg'>Ensure all details are filled in to successfully generate.</p>
