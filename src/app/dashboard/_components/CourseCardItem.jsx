    ...
    <div className='border rounded-lg shadow-md p-5'>
        <div>
            <div className='flex justify-between items-center'>
                ...
                <h2 className='text-[10px] p-1 px-2 rounded-full bg-blue-800 text-white'> 24 Dec 2023</h2>
            </div>
            <h2 className='mt-3 font-medium text-lg'>{course?.courseLayout.course_title}</h2>
            <p className='text-sm line-clamp-2 text-gray-700 mt-2'>{course?.courseLayout?.course_summary}</p>
